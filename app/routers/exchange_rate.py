...
def get_list(
    ...
    collection = Depends(get_collection("exchange_rates")),
):
    exchange_rates = exchange_rate_service.get_list(collection, params)
...
def get_item(
    ...
    exchange_rate = exchange_rate_service.get_item(collection, id)
    exchange_rate = {
        "id": exchange_rate["id"],
            "from_currency": exchange_rate["from_currency"],
            "to_currency": exchange_rate["to_currency"],
...
def create_item(
    ...
    exchange_rate_service.create_item(collection, data)
...
def update_item(
    ...
    exchange_rate_service.update_item(collection, id, data)
...
def delete_item(
    ...
    exchange_rate_service.delete_item(collection, id)
